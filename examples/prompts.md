...
```text
Use $ian-xiaohei-illustrations 把下面这篇文章生成 4 张 INBILY 小黑风正文配图。
...
不要画正式流程图，不要复刻旧案例。
请重新发明一个新的低科技隐喻，让 INBILY粉卫衣星钥少女参与核心动作。
```
...
```text
Use $ian-xiaohei-illustrations 这张图方向对，但 INBILY 角色有点像装饰。
请保持核心意思不变，重生成一版：让 INBILY粉卫衣星钥少女成为真正推动结构运转的人。
画面更怪一点，但仍然纯白、清爽、少字。
```
...
```text
Use $ian-xiaohei-illustrations 输出 5 个不同主题的 INBILY 小黑风正文配图效果。
